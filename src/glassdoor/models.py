...
def test_parse_review_url():
    # When it should work
    assert UrlBuilder.parse_review_url("https://www.glassdoor.com/Reviews/98point6-Reviews-E1181484.htm") == EmployerKey("98point6", "1181484")
...
def test_parse_overview_url():
    # When it should work
    assert UrlBuilder.parse_overview_url("https://www.glassdoor.com/Overview/Working-at-98point6-EI_IE1181484.11,19.htm") == EmployerKey("98point6", "1181484")

    # Make sure we handled the part after the ID correctly:
    assert UrlBuilder.parse_overview_url("https://www.glassdoor.com/Overview/Working-at-Kevala-Care-EI_IE5145912.11,22.htm") == EmployerKey("Kevala-Care", "5145912")
...
def test_find_employer_key():
    ...
    akili_results = ['https://www.glassdoor.com/Overview/Working-at-Akili-Interactive-Labs-EI_IE1796040.11,33.htm',
    ...
    assert UrlBuilder.find_employer_key(akili_results) == EmployerKey("Akili-Interactive-Labs", "1796040")

    # another example the used to fail:
    pomelo_results = ['https://www.glassdoor.com/Interview/Pomelo-Care-Interview-Questions-E9429297.htm',
    ...
    assert UrlBuilder.find_employer_key(pomelo_results) == EmployerKey("Pomelo-Care", "9429297")
